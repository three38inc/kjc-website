					...
					<div class="st-content-inner">
						<div class="container">
							...
							<div class="row" style="margin-top: 80px; padding-left: 10px; padding-right: 10px;">
								<img class="img-responsive col-lg-12" style="width:100%;max-height:300px;padding:0px;" src="../images/atm.jpg" alt="cover-img" />    
							</div>
							<div class="row">
								<div class="col-lg-9">
									<div class="content-left myWelcome wow fadeIn" style="min-height:611px;">
										<h4>
											...
											<span>&nbsp;<strong>ATM</strong></span>
										</h4>
										<hr />
										<div class="inner-content">
											<p> SIB ATM provides 24 hr service. It facilitates easy access for students to carry out quick bank transactions.<br /><br />
												</p>
