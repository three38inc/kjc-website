								...
								<div class="col-lg-9">
									<div class="content-left myWelcome wow fadeIn" style="min-height:611px;">
										<h4>
											...
											<span>&nbsp;<strong>Common Facilities</strong></span>
										</h4>
										<hr />
										<div class="inner-content">
											<p> The college has adequate infrastructure for effective functioning of all its academic programmes and non academic programme. Along with that college has made arrangement to offer value adder services to both students and faculty members.<br /><br />
											<h4 style="text-decoration:underline;">Common Facilities</h4>


											<ol style="list-style-type:decimal;">
												<li>Separate staff rooms for each department with cubicles</li>
												<li>Separate rest rooms for the boys and girls in each floor</li>
												<li>Retiring rooms for girls and amenities rooms</li>
												<li>Separate parking area for two wheelers and four wheelers</li>
												<li>Reverse Osmosis (RO) unit for purified drinking water</li>
												<li>Water harvest</li>
												<li>Student locker facility</li>
												<li>Postal, Intercom &amp; telecom facility</li>
												<li>Health center</li>
												<li>College bus for academic and recreation purpose</li>
												<li>Canteen</li>
												<li>Bank with ATM facilities (South Indian Bank ATM )</li>
												<li>Stationery and reprographic facilities</li>
											</ol>												
											</p>
