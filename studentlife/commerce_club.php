                            ...
                            <div class="col-lg-9">
                                <div class="content-left myWelcome wow fadeIn">
                                    ...
                                    <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                        <span>&nbsp;Commerce <strong> club</strong></span></h4>
									
									
									<p align=justify>Commerce Club is a forum which is designed to provide an in-depth understanding of the multinational environment. The club under the guidance of a staff-coordinator provides a comprehensive understanding of the cultural, financial, geopolitical and national and international economic issues that affect commerce activities. Moreover, the club regularly organizes programmes like extension lectures, seminars and industrial interactive sessions to suit the latest developments.</p>
                                </div>
                            </div>
                            <div class="col-lg-3">
								...
								<div class="content-right wow fadeIn" style="background-color: transparent;box-shadow: none;">
                                    ...
                                    <section class="link-arrow">
                                        <p><a class="a-link-arrow" href="commerce_club.php" style="color: #2980b9;font-weight: bold;">Commerce Club</a></p>
                                    </section>
									 <section class="link-arrow">
