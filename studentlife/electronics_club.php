                            ...
                            <div class="col-lg-9">
                                <div class="content-left myWelcome wow fadeIn">
                                    ...
                                    <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                        <span>&nbsp; Electronics <strong> Club  </strong></span></h4>
									
									
									<p align=justify> We are now in an era of fast-paced industrialization but the prescribed curriculum is not evolving at the same pace. To bridge this gap, the college has formed an Electronics Club. Under this club, students are exposed to various programmes like proficiency in electronic components, electronic projects and seminars by eminent industrial and research persons. Apart from industrial visits, seminars on current topics and training the students for inter-college fests are also undertaken</p>
                            ...
                            <div class="col-lg-3">
								...
								<div class="content-right wow fadeIn" style="background-color: transparent;box-shadow: none;">
                                    ...
                                    <section class="link-arrow">
									 ...
									 <section class="link-arrow">
                                        <p><a class="a-link-arrow" href="electronics_club.php" style="color: #2980b9;font-weight: bold;">Electronics Club</a></p>
                                    </section>
									 <section class="link-arrow">
