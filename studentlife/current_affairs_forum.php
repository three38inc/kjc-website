                            ...
                            <div class="col-lg-9">
                                <div class="content-left myWelcome wow fadeIn">
                                    ...
                                    <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                        <span>&nbsp;Current Affairs  <strong> Forum</strong></span></h4>
									
									
									<p align=justify> It is essential for a person to understand and know the environment which he works with. Through this forum, students are informed about the latest developments that take place in the world from time to time. Through critical evaluation of daily news and weekly reports, debates, group discussions etc., students not only gain a comprehensive knowledge but also equip themselves with the present day world demands. Apart from this, the forum also gives importance to communication and presentation skills.</p>
                            ...
                            <div class="col-lg-3">
								...
								<div class="content-right wow fadeIn" style="background-color: transparent;box-shadow: none;">
                                    ...
                                    <section class="link-arrow">
									 ...
									 <section class="link-arrow">
                                        <p><a class="a-link-arrow" href="current_affairs_forum.php" style="color: #2980b9;font-weight: bold;">Current Affairs Forum</a></p>
                                    </section>
									 <section class="link-arrow">
