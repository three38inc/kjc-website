                            ...
                            <div class="col-lg-9">
                                <div class="content-left myWelcome wow fadeIn">
                                    ...
                                    <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                        <span>&nbsp; Women Empowerment  <strong> Cell </strong></span></h4>
									
									
									<p align=justify>Gender discrimination is a continuous debate that rages social issues. Kristu Jayanti College has a women's cell that works towards empowering and elevating the position of women, and narrowing the gulf between gender discrepancies.</p>

									<p>Activities</p>
									<p>Seminars</p>
									<p>Street plays</p>
									<p>Special lectures and discussions</p>
									<p>Extending logistic and monetary help to under-privileged</p>
                            ...
                            <div class="col-lg-3">
								...
								<div class="content-right wow fadeIn" style="background-color: transparent;box-shadow: none;">
                                    ...
                                    <section class="link-arrow">
									 ...
									 <section class="link-arrow">
                                        <p><a class="a-link-arrow" href="women_empowerment_cell.php" style="color: #2980b9;font-weight: bold;">Women Empowerment Cell</a></p>
                                    </section>
