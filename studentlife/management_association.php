                            ...
                            <div class="col-lg-9">
                                <div class="content-left myWelcome wow fadeIn">
                                    ...
                                    <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                        <span>&nbsp; Management  <strong>Association </strong></span></h4>
									
									
									<p align=justify> Management Association is an association of BBM students under the guidance of the Management Department to develop the managerial and administrative skills of the students. In tune with this, association programmes are sharpened to develop planning, coordinating and decision making skills of the students and to equip them to face the challenges of their future career.</p>
                            ...
                            <div class="col-lg-3">
								...
								<div class="content-right wow fadeIn" style="background-color: transparent;box-shadow: none;">
                                    ...
                                    <section class="link-arrow">
									 ...
									 <section class="link-arrow">
                                        <p><a class="a-link-arrow" href="management_association.php" style="color: #2980b9;font-weight: bold;">Management Association</a></p>
                                    </section>
									 <section class="link-arrow">
