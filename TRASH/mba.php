...
<html lang="en" class="no-js">
    ...
    <div class="container-fluid">
        <div class="row">
                <?php include ('php/mba/navbar.php');  ?>
        </div>
    </div>
		<div id="st-container" class="st-container">
			<?php include('php/mba/offCanvasMenu.php'); ?>
...
<!--        <div class="row">-->
                                <div class="row" style="padding:0% 10px;">                	                    
                                    <?php include ('php/mba/carouselMain.php'); ?>               
                                </div>
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="content-left myWelcome">
                                            <?php include ('php/mba/welcome.php'); ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="content-right">
                                             <?php include ('php/mba/newsAndUpdates.php'); ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="content-left myNav">
                                            <?php include ('php/mba/navTabs.php'); ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="content-right">
                                            <?php include ('php/mba/sideMenu.php'); ?>
                                        </div>
                                    </div>                                        
                                </div>
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="content-left">
                                            <?php include('php/mba/highLights.php');?>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="content-right">
                                            <?php include('php/mba/testimonial.php');?>
                                        </div>
                                    </div>
                                </div>
<!--
...
<!--                                </div>-->
        <?php include('php/mba/footer.php'); ?>
