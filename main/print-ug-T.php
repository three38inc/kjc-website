...
{   
    ...
    while($row = mysqli_fetch_array($result))
    {
        ...
        <tr height='19px'>
            ...
            <tr height='18px'>
                <td  colspan='' valign='bottom'  style='line-height:12px;padding-left:100px;position:absolute;margin-top:6px;'>".$standard."</td><span style='font-size: 11px;
    position: absolute; font-family:sans-serif;
    top: 153px;
    left: 200px;'>Tourism - Vocational</span>
            </tr> 
            <tr height='18px'>
