								...
								<div class="col-lg-9">
									<div class="content-left myWelcome wow fadeIn">
										...
										<div class="inner-content">
											...
											<ul>
												<li>
													Tie-up with Regal hospital and Cratis Hospital for 24/7 medical support and care</li>
												<li>A medical officer from the Regal Hospital is available on campus on Tuesday and on    need basis</li>
												<li>First aid amenities are available in each block</li>
												<li>Retiring room facilities</li>
												<li>Awareness programmes on healthy practices</li>
												<li>Eye and dental camps, diabetes screening camp and general health camp are     organized by CSA and NSS</li>
												<li>Free health checkup in collaboration with neighbourhood clinics</li>
												<li>Awareness programmes on women health are organized by Women Empowerment     Cell</li>
												<li>Medical insurance scheme for faculty members and non-teaching staff</li>
											</ul>
