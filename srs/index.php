        ...
        <div class="st-pusher">
            <div class="st-content">
                ...
                <div class="st-content-inner">
                    <div class="container">
                        <!--        <div class="row">-->
                        <div class="row empty" style="margin-bottom:18vh;"></div>
                        <div class="row" style="padding:0% 5px;">
                            <img src="slider-images/slider.png" class="img-responsive"/>
                        </div>
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="content-spl myWelcome wow fadeIn" style="margin-bottom:1px;min-height:400px;">
                                    <?php include ('php/welcome.php'); ?>
                                </div>
                                <div style="clear: both;"></div>
                            </div>
                            <div class="col-lg-3">
                                <div class="content-spl wow fadeIn" style="height: 400px; overflow-y:hidden;">
