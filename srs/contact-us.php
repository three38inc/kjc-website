                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="content-left myWelcome wow fadeIn" style="min-height:1050px">
                                    ...
                                    <p>
                                        <div class="row">
                                            <h4 style="text-align:center;">Faculty Members</h5>
                                                <div class="col-lg-6"  style="text-align:center;">
                                                    Dr.Ambika.P<br/>Convenor<br/>Faculty Member, Department of Computer Science (PG)<br/>Ph: +91 9590399036
                                                </div>
                                                <div class="col-lg-6" style="text-align:center;">

                                                    Prof.Kumar R <br/>Chief Convenor<br/>Head, Department of Computer Science (PG)<br/>Ph: +91 9902933747 </div>
                                        </div>
                                    <br/>
                                    <div class="row" style="text-align:justify;padding:20px;">
                                        <h4>Address for Communication</h4>
                                        Chief Convenor – Student Research Symposium,<br/> Department of Computer Science(PG),<br/> Kristu Jayanti College (Autonomous)<br/> K. Narayanapura, Kothanur P.O,<br/> Bangalore-560077,Karnataka
                                        <br/> Phone: +91 8028465611 / +91 8028465353,<br/> Fax: +91 8028445161. <br/> www.kristujayanti.edu.in
                                        <br/> icctac@kristujayanti.com
                                        <br/>
                                    </div>
                                    </p>
