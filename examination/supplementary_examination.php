                            ...
                            <div class="col-lg-9">
                                <div class="content-left myWelcome wow fadeIn">
                                    ...
                                    <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                        <span>&nbsp; Supplementary <strong> Examination</strong></span>
                                    </h4>
									
									<p align=justify>Students can apply for supplementary examination on the scheduled dates given in the calendar pertaining to the following rules:
										Odd Semester Courses supplementary examination application can be done only with odd semester End Semester Examination.</p>
									<p align=justify>Even Semester Courses supplementary examination application can be done only with even semester End Semester Examination.</p>

									<p align=justify>Before the commencement of the last semester/trimester of the UG/PG programme students shall be allowed to appear for a special supplementary examinations where he/she can write any previous semester supplementary courses.</p>

									<p>The results of the supplementary examinations will be announced within 40 days after examination.</p>
 ...
 <a href="grading_cgpa.php" class="list-group-item">Grading and CGPA</a>
  ...
  <a href="result_announcement.php" class="list-group-item">Result Announcement</a>
										  ...
										  <a href="revaluations.php" class="list-group-item">Revaluation</a>
											  <a href="supplementary_examination.php" style="color: #2980b9;font-weight: bold;" class="list-group-item">Supplementary Examinationn</a>
