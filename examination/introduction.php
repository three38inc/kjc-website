...
<body>
    ...
    <div id="st-container" class="st-container">
        ...
        <div class="st-pusher">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="content-left myWelcome wow fadeIn">
									...
									<p align=justify>The college conducts term examinations (internal examinations) and class tests besides the End Semester Examinations for the continuous evaluation of students. The COE office is responsible for all matters connected with exam scheduling and conduct of examinations, arrangement for evaluation and declaration of results.</p>
          ...
          <a href="introduction.php" style="color: #2980b9;font-weight: bold;" class="list-group-item"> Introduction</a></div>
