                            ...
                            <div class="col-lg-9">
                                <div class="content-left myWelcome wow fadeIn">
                                    ...
                                    <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                        <span>&nbsp; Transcript/Marks  <strong>Card</strong></span>
                                    </h4>
									
									<p align=justify>Marks Card/Transcript for each semester/trimester will be issued within two months after the announcement of results. Individual semester transcript portray marks secured, credits earned, grades achieved and GPA (Grade Point Average) along with the overall status. At the completion of the programme students are issued the consolidated marks card which portrays CGPA (Cumulative Grade Point Average) in addition to the individual course marks/grade details of the entire programme. </p>
									
									<p>Semester/Consolidated marks card will also have details of credits achieved by the student through add on courses.</p>
                                </div>
                            </div>
                      <div class="col-lg-3">
 ...
 <a href="grading_cgpa.php" class="list-group-item">Grading and CGPA</a>
  ...
  <a href="result_announcement.php" class="list-group-item">Result Announcement</a>
										  ...
										  <a href="revaluations.php" class="list-group-item">Revaluation</a>
											  ...
											  <a href="marks_card_transcript.php" style="color: #2980b9;font-weight: bold;" class="list-group-item">Marks Card/Transcript</a>
