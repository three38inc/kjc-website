				...
				<div class="st-content"><!-- this is the wrapper for the content -->
					<div class="st-content-inner">
						<div class="container">
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="content-left myWelcome wow fadeIn" style="min-height:626px">
										<h4 >
										...
										<div class="inner-content">
											...
											<div class="table-responsive">
												<table class="table table-hover table-bordered">
													...
													<tbody>
														<tr>
															<td>Centre for Social Activities  (CSA)
															</td>
															<td>Students involvement in community engagement
															</td>
														</tr>
														<tr>
															<td>Social Outreach Programme (SOP)
															</td>
															<td>Awareness about vulnerable/disadvantaged sections of the society
															</td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td>Discipline, character formation, patriotism, serving the armed forces and national integration
															</td>
														</tr>
													</tbody>
												</table>
											...
											<p>
												These initiatives instill the spirit of selfless service, team work, discipline, leadership and contribute towards societal and national development.
											</p>
										</div>
									</div>
								</div>
