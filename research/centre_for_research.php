							...
							<div class="row">
								<div class="col-lg-9">
									<div class="content-left myWelcome wow fadeIn" style="min-height:538px">
										...
										<p>
											<strong >FDP ON APPLIED MULTIVARIATE ANALYSIS</strong><br />
											The Centre for Research of our college is organising a Faculty Development Programme (FDP) ON APPLIED MULTIVARIATE ANALYSIS from 3rd November 2015 to 13th November 2015 with the specific objectives of orienting the participants on recent and emerging trends in   quantitative analysis of data using SPSS
										</p>
									</div>
								</div>
							</div>
