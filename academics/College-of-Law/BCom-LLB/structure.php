                                    ...
                                    <div class="content-left myWelcome wow fadeIn">
                                       <img src="../images/<?php echo $imgNum; ?>.jpg" class="img-responsive" style="margin-bottom:20px;" />
                                        ...
                                        <h4 class="mainheading"><i class="fa fa-bookmark"></i>
											<span>&nbsp;<font size="5">B.Com LL.B. </font><strong>Course Structure</strong></span>
                                        </h4>
                                        ...
                                        <table border="0" class="table table-bordered table-hover">
                                            <tbody><tr>
                                                ...
                                                <tr>
                                                    <td width="115"><p align="center"><strong>I</strong></p></td>
                                                    <td width="228" valign="top"><ol>
                                                    ...
                                                    <td width="96"><p align="center"><strong>III </strong></p></td>
                                                    <td width="199" valign="top"><ol>
                                                        <li>Macro    Economics</li>
                                                        <li>Corporate    Accounting </li>
                                                        <li>Marketing    and Services Management </li>
                                                        <li>Cost    Accounting </li>
                                                        </ol>
                                                        <p>&nbsp;</p></td>
                                                </tr>
                                                <tr>
                                                    <td width="115"><p align="center"><strong>II</strong></p></td>
                                                    <td width="228" valign="top"><ol>
                                                        <li>Kannada/Special    English </li>
                                                        <li>Financial    Accounting </li>
                                                        <li>Principles    &amp; Practice of Management </li>
                                                        </ol></td>
                                                    <td width="96"><p align="center"><strong>IV</strong></p></td>
                                                    <td width="199" valign="top"><ol>
                                                        <li>Principles    and Practice of Auditing</li>
                                                        <li>Business    Statistics </li>
                                                        <li>Â&nbsp;Financial Management </li>
