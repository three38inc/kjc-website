                                ...
                                <div class="content-left myWelcome wow fadeIn">
                                 <img src="images/<?php echo $imgNum; ?>.jpg" class="img-responsive" style="margin-bottom:20px;" />
                                    ...
                                    <h4 class="mainheading"><i class="fa fa-bookmark"></i>
									 <span>&nbsp;Examination <strong> Time Table</strong></span>
                                    </h4>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="content-right wow fadeIn" style="background-color: transparent;box-shadow: none;">
                                    ...
                                    <section class="link-arrow">
                                        <p><a class="a-link-arrow" href="examination_timetable.php">Examination Time Table</a></p>
                                    </section>
									
									 <section class="link-arrow">
                                        <p><a class="a-link-arrow" href="examination_calendar.php">Examination Calendar</a></p>
                                    </section>


                                    <section class="link-arrow">
                                        <p><a class="a-link-arrow" href="assesment_regulations.php">Assesment Regulations</a></p>
                                    </section>
