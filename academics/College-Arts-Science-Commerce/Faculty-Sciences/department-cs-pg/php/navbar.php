        ...
        <div class="collapse navbar-collapse" id="main-navbar">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    ...
                    <a href="<?php echo $ROOT ; ?>/academics/College-Arts-Science-Commerce/Faculty-Sciences/department-cs-pg/mca.php" id="home">MCA</a>
                </li>
                <li>
                    <span class="brick hidden-md hidden-sm hidden-xs">&nbsp;</span>
                    <a href="<?php echo $ROOT ; ?>/academics/College-Arts-Science-Commerce/Faculty-Sciences/department-cs-pg/curriculum.php" id="home">Curriculum</a>
                </li>
                <li>
                    <span class="brick hidden-md hidden-sm hidden-xs">&nbsp;</span>
                    <a href="<?php echo $ROOT ; ?>/academics/College-Arts-Science-Commerce/Faculty-Sciences/department-cs-pg/academic_training.php" id="home">Training</a>
                </li>
                <li>
                    <span class="brick hidden-md hidden-sm hidden-xs">&nbsp;</span>
                ...
                <li>
                    <span class="brick hidden-md hidden-sm hidden-xs">&nbsp;</span>
                    <a  href="<?php echo $ROOT ; ?>/academics/College-Arts-Science-Commerce/Faculty-Sciences/department-cs-pg/admission.php" id="contact">Admission</a>
                </li>
