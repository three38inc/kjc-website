                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                    <span>&nbsp; Certificate <strong>Programme</strong></span></h4>
								
								<p>In order to strengthen the teaching-learning ambience, and to prepare the students to meet the challenges of the global work environment, along with the MCA course, the certificate courses are conducted. The following Certificate Courses will be offered for the academic year 2014-2015.</p>
													...
													<div class="panel-heading" role="tab" id="headingOne">
														<h5 class="panel-title">
															<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
																...
																Web Designing Course for UG classes
															</a>
														</h5>
													</div>
													<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
														<div class="panel-body">
															<p><b>The Objectives of the course are:</b><br>
•	Understand the importance of the web as a medium of communication.<br>
•	Understand the principles of creating an effective web page, including an in-depth Consideration of information architecture.<br>
•	Become familiar with graphic design principles that relate to web design and learn how to implement these theories into practice.<br>
																•	Develop skills in analyzing the usability of a web site.</p>
															<p><b>Curriculum</b><br>
• Basics of Web page, Website and Internet<br>
• HTML<br>
•CSS<br>
																• Java Script</p>
													...
													<div class="panel-heading" role="tab" id="headingTwo">
														<h5 class="panel-title">
															<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
																...
																Spread Sheet for Business Applications for MBA students <br>
							 Spread Sheet for Business Applications for B.Com and BBM students
															</a>
														</h5>
													</div>
