...
<body>
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td>02,03.03.2017</td>
      <td>IEEE ICCTAC (International Conference on Current Trends in Advanced Computing)</td>
    </tr>
	   <tr>
      <th scope="row">2</th>
      <td>16.01.2017</td>
      <td>Workshop on “Digital Convergence for Smart Life”</td>
    </tr>
	   <tr>
      <th scope="row">3</th>
      <td>23.07.2016</td>
      <td>Tech Talk on “Hands-on Introduction to Docker”</td>
    </tr>
    </tbody>
</table>

<p>•	EMC2 Academic Alliance – As a part of curriculum, Cloud Infrastructure Service is included<br>
•	CSI Student Branch – Under the banner of CSI various activities were conducted.<br>
	•	IIT Mumbai – conducted workshop on FOSS (Free and Open Source Software) like C, Java, python and PHP for MCA Students.</p>
