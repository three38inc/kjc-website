                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                    <span>&nbsp; International <strong> Conference</strong></span></h4>
								<p align=justify><b>INTERNATIONAL CONFERENCE ON CURRENT TRENDS IN ADVANCED COMPUTING (ICCTAC).</b><br>
                            ...
                            <div class="col-lg-3" style="margin-top:1em;">
                                <div class="content-right wow fadeIn" style="background-color: transparent;box-shadow: none;">
                                    ...
                                    <section class="link-arrow">
                                        <p><a class="a-link-arrow" href="international_conference.php" style="color: #2980b9;font-weight: bold;">International Conference</a></p>
                                    </section>
