<!DOCTYPE html> <?php  $ROOT="http://".$_SERVER['HTTP_HOST'].""; $imgNum = mt_rand(1,3);/*$ROOT is the base URL & should on top of every PAGE */?> 
                        ...
                        <div class="row">
                            <div class="col-lg-9">
								 <div class="content-left myWelcome wow fadeIn">
									 <img src="images/lab/<?php echo $imgNum; ?>.jpg" class="img-responsive" style="margin-bottom:20px;" />
