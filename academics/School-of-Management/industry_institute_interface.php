                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                    <span>&nbsp; Industry Institute <strong>  Interface (3i) </strong></span></h4>
								
								<p  align=justify>Industry Institute Interface (3i) is one of the key activities of the Kristu Jayanti School of Management organized for first year MBA/PGDM students every year. Industry experts at the middle management level and also Alumni of Kristu Jayanti College are invited to address students to share their practical experience and also to bridge the gap between the theoretical knowledge and the practical experiences. The following are the interactions that took place in the year 2016-17:</p>
								
								
								<div class="row profile-pagination">
                                        <ul class="pagination pagination-sm">
											<li class="active"><a href="#" data-value="page1">2016-17</a></li>
