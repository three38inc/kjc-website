                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                    <span>&nbsp; Current <strong>Business Awareness</strong></span></h4>
								
								<p align=justify>Ist year MBA & PGDM: To increase the awareness levels of students in current affairs, the department arranged with the XED group to provide newsletters for students and daily SMS-s on important headlines so as to increase the current awareness levels of the students. Every week an online test is also being conducted to test the proficiency of the students in general and current business topics.</p>
								<p align=justify>IInd year MBA & PGDM: For the second year students the XED group holds Functional Aptitude Training along with the current business awareness sessions. Online weekly tests are also held to gauge the student proficiency levels.</p>

								
							<center><img src="images/computer.jpg"></center>	
