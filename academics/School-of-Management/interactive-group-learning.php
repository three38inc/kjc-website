                        ...
                        <div class="row">
                            <div class="col-lg-9">
								<div class="content-left myWelcome wow fadeIn">
									<img src="images/interactive-group-learning.jpg" class="img-responsive" style="margin-bottom:20px;" />

                                <h4 class="mainheading"><i class="fa fa-bookmark"></i>
                                    <span>&nbsp; <strong>Interactive Group Learning</strong></span></h4>
								
								<p align=justify>Group learning embodies an intellectually engaged student community. Kristu Jayanti School of Management offers a platform for the student community to learn as a group in an interactive environment through its one of the best practices labeled as Current Business Awareness (CBA). The main objective of CBA is to offer an interactive group learning platform for the students and also to discuss the current happenings in the Global World of Business. The first year MBA/PGDM students are divided into different groups. Every week each group gets an opportunity to take lead in conducting the event.</p>
								<p align=justify>The team that leads the event would engage the entire batch by conducting quizzes, debates, discussions, cross words etc. They also present the business news of the week, book reviews, article study etc. All the groups are also evaluated and appreciated. The entire event though conducted by the students, is strictly monitored by the faculties that the time and resources are utilized productively. This event has helped the students to stay tuned with the current happenings and to stay upbeat in their learning.</p>
