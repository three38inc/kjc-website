        ...
        <div class="st-pusher">
            <div class="st-content">
                ...
                <div class="st-content-inner">
                    <div class="container">
                        <!--        <div class="row">-->
                        <div class="row" style="margin-top: 100px; padding-left: 0px; padding-right: 0px;">
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="row wow fadeIn" style="padding-top: 12px;background-color: #fff;margin-left: -6px;margin-top: 6px;margin-right: 6px;">
...
-->
    ...
    <!--    <script src="../js/js_composer.min.js"></script>-->
